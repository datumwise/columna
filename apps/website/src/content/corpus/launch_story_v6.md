...
Our own instrument, built to catch silent binding, was silently binding — and punishing honesty about it. A human re-grade caught it. We fixed the key, and the models' honest disclosures flipped from penalties to credit.
