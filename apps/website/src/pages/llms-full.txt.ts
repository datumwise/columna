...
//   2. the ratified "What is Columna?" front-door body (what_is_columna_draft_v0_6.md) — verbatim
//   3. a short "Live demo describe" pointer to the live Explorer (reuses the ratified §1a pointers)
import fs from 'node:fs';
import wiBody from '../content/corpus/what_is_columna_draft_v0_6.md?raw';
