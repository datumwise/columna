...
| # | file | what it is |
|---|---|---|
| 1 | `open_planner_fork_v0_12.md` | **the fork document** — the development brief. DESIGN, pre-implementation. Governs. *(Supersedes v0.11 → `superseded/`; §11 is beat 2's permanent record — COMPLETE AND CLOSED by ratifier ruling: the outbound mapping study, two conservation certificates + two rule certificates, D2 cargo schema v0.2 accepted by its own native emission. Beat 3 scoped in the §11 tail. Earlier lineage: v0.8/v0.11 in `superseded/`.)* |
