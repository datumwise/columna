...
| # | file | what it is |
|---|---|---|
| 1 | `open_planner_fork_v0_13.md` | **the fork document** — the development brief. DESIGN, pre-implementation. Governs. *(Supersedes v0.12 → `superseded/`; §12 is beat 3's permanent record — the two seams held: the vertical split **verified not asserted**, the horizontal transfer **2/2** with amortization measured at ~0.2s/rule, and the study's first surprise producing the execution-error retry razor. §11 is beat 2's record. Earlier lineage: v0.8/v0.11/v0.12 in `superseded/`.)* |
| 1b | `map2/` | **beat-2 deliverables** — the outbound mapping study (charter, D1 lowering table, D2 schema v0.2 + reconciliation, D3 oracle harness, D4 C1/C2 pilots, D5 ledger); rule certificates in `map2/adjudication_record/`. |
...
| 3 | `open_planner_deposit_v1_3.md` | **the published program note** — v1.3, 2026-07-29, CC-BY 4.0, **DOI [10.5281/zenodo.21695710](https://doi.org/10.5281/zenodo.21695710)**. Source of the deposited PDF. *(v1.0 remains in place as the prior version — [10.5281/zenodo.21632723](https://doi.org/10.5281/zenodo.21632723) — and the deposit's own version line carries the v1.0→v1.3 history.)* **Corrected 2026-08-21.** This row previously gave v1.3's DOI as `…21632723`, which is v1.0's. The frozen deposit file's own byline still says the same thing and is **left exactly as it is**: it is the historical artifact, its bytes are the record of what was published, and a defect in a deposit is fixed at the deposit or not at all. This README is not that artifact — it is a current document making a current claim — so it says what is true. See reconciliation item `rc-open-planner-v13-doi`. |
