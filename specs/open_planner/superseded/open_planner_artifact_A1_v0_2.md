# Open Planner — Artifact A1: the extracted Plan IR + the Cascadia attack set (v0.2)
...
from the artifact. Delivered under the artifact gate. Method:
...
CARVE(transaction) · COLUMN(**units**, sum) · CROSS(product↔category,
