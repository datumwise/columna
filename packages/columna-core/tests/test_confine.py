"""
test_confine.py — mirrors demos/confine_demo.py.

Each of the suite's 12 checks becomes one pytest item (the check name is the test id), run against
