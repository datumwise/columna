"""
test_projection.py — mirrors demos/projection_demo.py.

Each of the suite's 16 checks becomes one pytest item (the check name is the test id), run against
...
_RUN = fixture_run("projection_demo")
