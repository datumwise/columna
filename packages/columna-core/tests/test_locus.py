"""
test_locus.py — mirrors demos/locus_demo.py.

Each of the suite's 11 checks becomes one pytest item (the check name is the test id), run against
