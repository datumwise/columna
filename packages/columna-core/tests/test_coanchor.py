"""
test_coanchor.py — mirrors demos/coanchor_demo.py.

Each of the suite's 17 checks becomes one pytest item (the check name is the test id), run against
...
_RUN = fixture_run("coanchor_demo")
